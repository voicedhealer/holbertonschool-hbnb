...
# --- Endpoints Blueprint (hors Namespace) ---
...
# --- Endpoints réservés aux admins (Namespace RESTX) ---
...
class AdminUserCreateList(Resource):
    ...
    def post(self):
        ...
        user_data = api.payload or request.json or {}
        email = user_data.get('email')
        if not email:
            return {'error': "Le champ 'email' est requis"}, 400
...
class Login(Resource):
    ...
    def post(self):
        ...
        if not username or not password:
            return {"msg": "Champs 'username' et 'password' requis"}, 400
