...
# Création des extensions AVANT toute importation de modèles
db = SQLAlchemy()
bcrypt = Bcrypt()
jwt = JWTManager()
...
def create_app(config_class="app.config.DevelopmentConfig"):
    ...
    # Importation des modèles AVANT db.create_all()
    ...
    from app.api.v1.users import users_bp, api as users_ns
    ...
    def init_db_command():
        ...
        with app.app_context():
            # Import explicite des modèles AVANT db.create_all()
            from app.models.user import User
            from app.models.place import Place
            from app.models.review import Review
            from app.models.amenity import Amenity
